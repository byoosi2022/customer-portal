...
// Route to profile page when "View More" button is clicked
document.getElementById('route-to-profile').addEventListener('click', function() {
    window.location.href = '/client_portal/user/user_profile';
});


// Function to route to the profile page
function routeToProfile() {
    const button = document.getElementById("route-to-profile");
    
    // Check if the button is visible and proceed to route to the profile page
